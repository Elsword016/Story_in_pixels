...
comb_path = os.path.join(BASE_DIR, 'combined_data.csv')
dash_path = os.path.join(BASE_DIR,'data_dashboard.pdf')
...
combined_data = load_combined_data(comb_path)

#st.markdown("**Date:** October 26, 2020")
